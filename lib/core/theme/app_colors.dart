...
class AppColors {
  ...
  static const List<List<Color>> iconTints = [
    [Color(0xFFDCF1E3), Color(0xFF2F9E5C)],
    [Color(0xFFDCE8F7), Color(0xFF3B7DD8)],
    [Color(0xFFF7E1E9), Color(0xFFD6538A)],
    [Color(0xFFEDE1F7), Color(0xFF8A4FCF)],
    [Color(0xFFFBEBD6), Color(0xFFD68A2F)],
    [Color(0xFFFCE1E1), Color(0xFFD65B5B)],
    [Color(0xFFDAF1EE), Color(0xFF1F9E8E)],
  ];
}
